...
const N: Record<TenantKey, string> = {
  infosys:    '30000000-0000-0000-0000-000000000C01',
  tata:       '30000000-0000-0000-0000-000000000C02',
  reliance:   '30000000-0000-0000-0000-000000000C03',
  tcs:        '30000000-0000-0000-0000-000000000C04',
  siemens:    '30000000-0000-0000-0000-000000000C05',
  ...
  givaudan:   '30000000-0000-0000-0000-000000000C09',
